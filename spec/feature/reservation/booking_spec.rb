...
" do
  ...
  describe 'User' do
    ...
    describe 'reservations' do
      ...
      background do
        Reservation.create(start_time: date_now, end_time: date_now + 3600, user: user, computer: computer)
        visit reservations_path
      end

      scenario 'sees current reservations on сertain date' do
        date_tomorrow = date_now + 1.day
        Reservation.create(start_time: date_tomorrow, end_time: date_tomorrow + 3600, user: user, computer: computer)
    ...
    scenario 'Computer alredy reserved' do
      ...
      Reservation.create(start_time: start_time, end_time: start_time + 3600, user: user, computer: computer)
  ...
  describe 'Admin ' do
    ...
    scenario 'can not reserve computer for user with time intersection' do
      start_time = Time.zone.now
      Reservation.create(start_time: start_time, end_time: start_time + 3600, user: admin, computer: computer)
    ...
    scenario 'can remove reservation' do
      Reservation.create(start_time: date_now, end_time: date_now + 3600, user: admin, computer: computer)
